                    ...
                    <div class="main checkout__mian">
                        <form action="#">
                            <div class="checkout__content--step section__contact--information">
                                <div class="section__header checkout__section--header d-flex align-items-center justify-content-between mb-25">
                                    ...
                                    <p class="layout__flex--item">
                                        ...
                                        <a class="layout__flex--item__link" href="/loginPage">Log in</a>  
                                    </p>
                                </div>
                            ...
                            <div class="checkout__content--step__footer d-flex align-items-center">
                                <a class="continue__shipping--btn primary__btn border-radius-5" href="/home">Continue To Shipping</a>
                                <a class="previous__link--content" href="/cartPage">Return to cart</a>
                            </div>
                        </form>
                    </div>
                </div>
                                ...
                                <tbody class="cart__table--body">
                                        ...
                                        <td class="cart__table--body__list">
                                            <div class="product__image two  d-flex align-items-center">
                                                <div class="product__thumbnail border-radius-5">
                                                    <a class="display-block" href="/standardProduct"><img class="display-block border-radius-5" src="assets/img/product/small-product1.webp" alt="cart-product"></a>
                                                    <span class="product__thumbnail--quantity">1</span>
                                                </div>
                                                <div class="product__description">
                                                    <h4 class="product__description--name"><a href="/standardProduct">Fresh-whole-fish</a></h4>
                                    ...
                                    <tr class="cart__table--body__items">
                                        <td class="cart__table--body__list">
                                            <div class="cart__product d-flex align-items-center">
                                                <div class="product__thumbnail border-radius-5">
                                                    <a class="display-block" href="/standardProduct"><img class="display-block border-radius-5" src="assets/img/product/small-product2.webp" alt="cart-product"></a>
                                                    <span class="product__thumbnail--quantity">1</span>
                                                </div>
                                                <div class="product__description">
                                                    <h4 class="product__description--name"><a href="/standardProduct">Vegetable-healthy</a></h4>
                                    ...
                                    <tr class="cart__table--body__items">
                                        <td class="cart__table--body__list">
                                            <div class="cart__product d-flex align-items-center">
                                                <div class="product__thumbnail border-radius-5">
                                                    <a class="display-block" href="/standardProduct"><img class="display-block border-radius-5" src="assets/img/product/small-product4.webp" alt="cart-product"></a>
                                                    <span class="product__thumbnail--quantity">1</span>
                                                </div>
                                                <div class="product__description">
                                                    <h4 class="product__description--name"><a href="/standardProduct">Raw-onions-surface</a></h4>
