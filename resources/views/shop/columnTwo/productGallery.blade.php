            ...
            <div class="row row-cols-1">
                <div class="col">
                    <div class="breadcrumb__content">
                        <h1 class="breadcrumb__content--title text-white mb-10">Product Gallery</h1>
                ...
                <div class="col">
                    <div class="product__details--gallery">
                        <div class="row row-cols-2 mb--n28">
                            <div class="col mb-28">
                                <img class="display-block" src="assets/img/product/big-product1.webp" alt="">
                            </div>
                            <div class="col mb-28">
                                <img class="display-block" src="assets/img/product/big-product2.webp" alt="">
                            </div>
                            <div class="col mb-28">
                                <img class="display-block" src="assets/img/product/big-product3.webp" alt="">
                            </div>
                            <div class="col mb-28">
                                <img class="display-block" src="assets/img/product/big-product4.webp" alt="">
                            </div>
                        </div>
                    </div>
                </div>   
