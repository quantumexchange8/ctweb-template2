            ...
            <div class="row row-cols-1">
                <div class="col">
                    <div class="breadcrumb__content">
                        <h1 class="breadcrumb__content--title text-white mb-10">Product Sidebar</h1>
                        <ul class="breadcrumb__content--menu d-flex">
                            <li class="breadcrumb__content--menu__items"><a class="text-white" href="/home">Home</a></li>
                            <li class="breadcrumb__content--menu__items"><span class="text-white">Product Sidebar</span></li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                <div class="tab_content">
                                    <div id="description" class="tab_pane active show">
                                        <div class="product__tab--content">
                                            <div class="product__tab--content__items style2 mb-40 d-flex align-items-center">
                                                <div class="product__tab--content__thumbnail style2">
                                            ...
                                            <div class="product__tab--content__items style2 d-flex align-items-center">
                                                <div class="product__tab--content__thumbnail style2">
