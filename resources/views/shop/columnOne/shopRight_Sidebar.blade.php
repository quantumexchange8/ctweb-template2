            ...
            <div class="row row-cols-1">
                <div class="col">
                    <div class="breadcrumb__content">
                        <h1 class="breadcrumb__content--title text-white mb-10">Shop Right</h1>
                                            ...
                                            <div class="product__items product__list--items border-radius-5 d-flex align-items-center">
                                                <div class="product__list--items__left d-flex align-items-center">
                                                    ...
                                                    <div class="product__list--items__content">
                                                        ...
                                                        <h4 class="product__list--items__content--title mb-15"><a href="/standardProduct">Larger Minimal Wooden Chair</a></h4>
                                                ...
                                                <div class="product__list--items__right">
                                                    ...
                                                    <div class="product__list--action">
                                                        <a class="product__list--action__cart--btn primary__btn" href="/cartPage">
                                                        ...
                                                        <ul class="product__list--action__wrapper d-flex align-items-center">
                                                            ...
                                                            <li class="product__list--action__child">
                                                                <a class="product__list--action__btn" href="/wishlistPage">
                                                            ...
                                                            <li class="product__list--action__child">
                                                                <a class="product__list--action__btn" href="/comparePage">
                                            ...
                                            <div class="product__items product__list--items border-radius-5 d-flex align-items-center">
                                                <div class="product__list--items__left d-flex align-items-center">
                                                    ...
                                                    <div class="product__list--items__content">
                                                        ...
                                                        <h4 class="product__list--items__content--title mb-15"><a href="/standardProduct">White Minimalist Combo Sofa</a></h4>
                                                        <p class="product__list--items__content--desc m-0">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quia voluptas dolore doloribus architecto sequi corporis deleniti officia culpa dolor esse consectetur eligendi.</p>
                                                    </div>
                                                </div>
                                                <div class="product__list--items__right">
                                            ...
                                            <div class="product__items product__list--items border-radius-5 d-flex align-items-center">
                                                <div class="product__list--items__left d-flex align-items-center">
                                                    ...
                                                    <div class="product__list--items__content">
                                                        ...
                                                        <h4 class="product__list--items__content--title mb-15"><a href="/standardProduct">Modern Swivel Chair</a></h4>
                                                        <p class="product__list--items__content--desc m-0">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quia voluptas dolore doloribus architecto sequi corporis deleniti officia culpa dolor esse consectetur eligendi.</p>
                                                    </div>
                                                </div>
                                                <div class="product__list--items__right">
                                        ...
                                        <div class="col mb-30">
                                            <div class="product__items product__list--items border-radius-5 d-flex align-items-center">
                                                <div class="product__list--items__left d-flex align-items-center">
                                                    ...
                                                    <div class="product__list--items__content">
                                                        <span class="product__items--content__subtitle mb-5">Wooden</span>
                                                        <h4 class="product__list--items__content--title mb-15"><a href="/standardProduct">Modern Stylish Single Sofa</a></h4>   
                                                        <p class="product__list--items__content--desc m-0">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quia voluptas dolore doloribus architecto sequi corporis deleniti officia culpa dolor esse consectetur eligendi.</p>
                                                    </div>
                                                </div>
                                                <div class="product__list--items__right">
                                            ...
                                            <div class="product__items product__list--items border-radius-5 d-flex align-items-center">
                                                <div class="product__list--items__left d-flex align-items-center">
                                                    ...
                                                    <div class="product__list--items__content">
                                                        ...
                                                        <h4 class="product__list--items__content--title mb-15"><a href="/standardProduct">New Furniture Tree Planet</a></h4>   
                                                        <p class="product__list--items__content--desc m-0">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quia voluptas dolore doloribus architecto sequi corporis deleniti officia culpa dolor esse consectetur eligendi.</p>
                                                    </div>
                                                </div>
                                                <div class="product__list--items__right">
                                        ...
                                        <div class="col mb-30">
                                            <div class="product__items product__list--items border-radius-5 d-flex align-items-center">
                                                <div class="product__list--items__left d-flex align-items-center">
                                                    ...
                                                    <div class="product__list--items__content">
                                                        <span class="product__items--content__subtitle mb-5">Wooden</span>
                                                        <h4 class="product__list--items__content--title mb-15"><a href="/standardProduct">Single Stylish Mini Chair</a></h4>
                                                        <p class="product__list--items__content--desc m-0">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quia voluptas dolore doloribus architecto sequi corporis deleniti officia culpa dolor esse consectetur eligendi.</p>
                                                    </div>
                                                </div>
                                                <div class="product__list--items__right">
                        ...
                        <div class="pagination__area bg__gray--color">
                            <nav class="pagination justify-content-center">
                                <ul class="pagination__wrapper d-flex align-items-center justify-content-center">
                                    <li class="pagination__list"><a href="/shopLeft_Sidebar" class="pagination__item--arrow  link ">
                                    ...
                                    <li class="pagination__list"><a href="/shopLeft_Sidebar" class="pagination__item link">2</a></li>
                                    <li class="pagination__list"><a href="/shopLeft_Sidebar" class="pagination__item link">3</a></li>
                                    <li class="pagination__list"><a href="/shopLeft_Sidebar" class="pagination__item link">4</a></li>
                                    <li class="pagination__list"><a href="/shopLeft_Sidebar" class="pagination__item--arrow  link ">
                    ...
                    <div class="shop__sidebar--widget widget__area d-md-2-none">
                                ...
                                <li class="widget__categories--menu__list">
                                    ...
                                    <ul class="widget__categories--sub__menu">
                                        <li class="widget__categories--sub__menu--list">
                                            <a class="widget__categories--sub__menu--link d-flex align-items-center" href="/shopLeft_Sidebar">
                            ...
                            <div class="product__grid--inner">
                                <div class="product__items product__items--grid d-flex align-items-center">
                                    ...
                                    <div class="product__items--grid__content">
                                        <h3 class="product__items--content__title h4"><a href="/standardProduct">Modern Chair</a></h3>
                                        <div class="product__items--price">
                                            <span class="current__price">$165.00</span>
                                        </div>
                                        <div class="product__items--color">
                                ...
                                <div class="product__items product__items--grid d-flex align-items-center">
                                    ...
                                    <div class="product__items--grid__content">
                                        <h3 class="product__items--content__title h4"><a href="/standardProduct">Design Rooms</a></h3>
                                        <div class="product__items--price">
                                            <span class="current__price">$165.00</span>
                                        </div>
                                        <div class="product__items--color">
                        ...
                        <div class="single__widget widget__bg">
                            ...
                            <ul class="widget__tagcloud">
                                <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="/shopLeft_Sidebar">Wooden</a></li>
                                <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="/shopLeft_Sidebar">Chair</a></li>
                                <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="/shopLeft_Sidebar">Modern</a></li>
                                <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="/shopLeft_Sidebar">Fabric  </a></li>
                                <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="/shopLeft_Sidebar">Shoulder </a></li>
                                <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="/shopLeft_Sidebar">Winter</a></li>
                                <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="/shopLeft_Sidebar">Accessories</a></li>
                                <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="/shopLeft_Sidebar">Dress </a></li>
                            </ul>
                        </div>
                    </div>
                </div>
