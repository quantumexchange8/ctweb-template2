                                ...
                                <div class="row row-cols-1">
                                    <div class="col">
                                        <div class="slider__content">
                                            ...
                                            <a class="slider__content--btn primary__btn" href="/shopLeft_Sidebar">Start to Buying</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row mb--n28">
                <div class="col-lg-6 col-md-6 col-sm-6 mb-28">
                    <div class="banner__items">
                        <a class="banner__items--thumbnail position__relative" href="/shopLeft_Sidebar"><img class="banner__items--thumbnail__img" src="assets/img/banner/banner1.webp" alt="banner-img">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 mb-28">
                    <div class="banner__items">
                        <a class="banner__items--thumbnail position__relative" href="/shopLeft_Sidebar"><img class="banner__items--thumbnail__img" src="assets/img/banner/banner2.webp" alt="banner-img">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 mb-28">
                    <div class="banner__items">
                        <a class="banner__items--thumbnail position__relative" href="/shopLeft_Sidebar"><img class="banner__items--thumbnail__img" src="assets/img/banner/banner3.webp" alt="banner-img">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 mb-28">
                    <div class="banner__items mb-25">
                        <a class="banner__items--thumbnail position__relative" href="/shopLeft_Sidebar"><img class="banner__items--thumbnail__img" src="assets/img/banner/banner4.webp" alt="banner-img">
                    ...
                    <div class="banner__items">
                        <a class="banner__items--thumbnail position__relative" href="/shopLeft_Sidebar"><img class="banner__items--thumbnail__img" src="assets/img/banner/banner5.webp" alt="banner-img">
                            ...
                            <div class="col mb-30">
                                <div class="product__items ">
                                    ...
                                    <div class="product__items--content text-center">
                                        ...
                                        <h3 class="product__items--content__title h4"><a href="/standardProduct">Design Rooms Sofa</a></h3>
                                        <div class="product__items--price">
                                            <span class="current__price">$155.00</span>
    ...
    <section class="banner__section section--padding pt-0">
        <div class="container-fluid">
            <div class="row row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-1 mb--n28">
                <div class="col mb-28">
                    <div class="banner__items">
                        <a class="banner__items--thumbnail position__relative" href="/shopLeft_Sidebar"><img class="banner__items--thumbnail__img" src="assets/img/banner/banner6.webp" alt="banner-img">
                ...
                <div class="col mb-28">
                    <div class="banner__items">
                        <a class="banner__items--thumbnail position__relative" href="/shopLeft_Sidebar"><img class="banner__items--thumbnail__img" src="assets/img/banner/banner7.webp" alt="banner-img">
                            <div class="banner__items--content__style2 right">
                ...
                <div class="col mb-28">
                    <div class="banner__items">
                        <a class="banner__items--thumbnail position__relative" href="/shopLeft_Sidebar"><img class="banner__items--thumbnail__img" src="assets/img/banner/banner8.webp" alt="banner-img">
            ...
            <div class="row">
                                ...
                                <div class="col mb-25">
                                    <div class="product__items">
                                        ...
                                        <div class="product__items--content style2 position__relative">
                                            ...
                                            <h3 class="product__items--content__title h4"><a href="/standardProduct">Fashion Chair</a></h3>
                                            ...
                                            <a class="product__cart--btn__style2 primary__btn" href="/cartPage">  Add to cart </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col mb-25">
                                    <div class="product__items">
                                        ...
                                        <div class="product__items--content style2 position__relative">
                                            ...
                                            <h3 class="product__items--content__title h4"><a href="/standardProduct">Globe Electric</a></h3>
                                            <div class="product__items--price style2">
                                ...
                                <div class="col mb-25">
                                    <div class="product__items">
                                        ...
                                        <div class="product__items--content style2 position__relative">
                                            ...
                                            <h3 class="product__items--content__title h4"><a href="/standardProduct">Swivel Chair</a></h3>
                                            <div class="product__items--price style2">
                                ...
                                <div class="col mb-25">
                                    <div class="product__items">
                                        ...
                                        <div class="product__items--content style2 position__relative">
                                            ...
                                            <h3 class="product__items--content__title h4"><a href="/standardProduct">Plastic Chair</a></h3>
                                            <div class="product__items--price style2">
                                ...
                                <div class="col mb-25">
                                    <div class="product__items">
                                        ...
                                        <div class="product__items--content style2 position__relative">
                                            ...
                                            <h3 class="product__items--content__title h4"><a href="/standardProduct">Folding Tables</a></h3>
                                            <div class="product__items--price style2">
                                ...
                                <div class="col mb-25">
                                    <div class="product__items">
                                        ...
                                        <div class="product__items--content style2 position__relative">
                                            ...
                                            <h3 class="product__items--content__title h4"><a href="/standardProduct">Tables Chairs</a></h3>
                                            <div class="product__items--price style2">
                                ...
                                <div class="col d-xl-none d-xxl-block mb-25">
                                    <div class="product__items">
                                        ...
                                        <div class="product__items--content style2 position__relative">
                                            ...
                                            <h3 class="product__items--content__title h4"><a href="/standardProduct">Fabric Chair</a></h3>
                                            <div class="product__items--price style2">
                ...
                <div class="col-xl-4 offset-xl-0 col-lg-6 offset-lg-3 col-md-8  product__col--width__4">
                    <div class="deals__banner--thumbnail">
                        <a class="deals__banner--thumbnail__link display-block position__relative" href="/shopLeft_Sidebar"><img class="deals__banner--thumbnail__img display-block" src="assets/img/banner/banner9.webp" alt="deals-thumbnail-img">
            ...
            <div class="row row-cols-xl-2 row-cols-1">
                <div class="col col-lg-order">
                    <div class="testimonial__banner--thumbnail">
                        <a class="display-block" href="/shopLeft_Sidebar"><img class="testimonial__banner--thumbnail__img display-block" src="assets/img/banner/banner10.webp" alt="banner-img"></a>
                    </div>
                </div>
                <div class="col">
