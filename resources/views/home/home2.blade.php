...
<main class="main__content_wrapper">
            ...
            <div class="row">
                                ...
                                <div class="hero__slider2--items hero__slider--bg2 slider1">
                                    <div class="hero__slider2--items__inner">
                                        <div class="slider__content2 text-center">
                                            <p class="slider__content2--desc desc1 text-white mb-15">Making Beautiful Your Home</p> 
                                            <h2 class="slider__content2--maintitle text-white h1">Build Your Home  <br>
                                                With Furniture</h2>   
                                            <a class="slider__content2--btn primary__btn" href="/shopLeft_Sidebar" rel="nofollow">Get Disscount</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-3 banner2__col--3">
                    <div class="banner__sidebar--two banner__items banner__sidebar2">
                        <a class="banner__items--thumbnail position__relative" href="/shopLeft_Sidebar"><img class="banner__items--thumbnail__img banner__sidebar2--img" src="assets/img/banner/banner11.webp" alt="banner-img">
            ...
            <div class="row mb--n28">
                <div class="col-lg-6 col-md-6 banner2__col--6 mb-28">
                    <div class="banner__items position__relative">
                        <a class="banner__items--thumbnail " href="/shopLeft_Sidebar"><img class="banner__items--thumbnail__img" src="assets/img/banner/banner12.webp" alt="banner-img">
                            <div class="banner__content--style2">
                                <h3 class="banner__content--style2__subtitle">Get Discount Up to 80%</h3>
                                <h2 class="banner__content--style2--title">White Minimalist <br>
                                    Combo Sofa </h2>
                                <span class="banner__content--style2__link primary__btn style2">Buy Now</span>    
                            </div>
                        </a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 banner2__col--6r mb-28">
                    <div class="banner__items position__relative mb-25">
                        <a class="banner__items--thumbnail " href="/shopLeft_Sidebar"><img class="banner__items--thumbnail__img banner__img--height" src="assets/img/banner/banner13.webp" alt="banner-img">
                            <div class="banner__content--style2">
                                <h3 class="banner__content--style2__subtitle text-ofwhite d-md-none">Get Discount Up to 80%</h3>
                                <h2 class="banner__content--style2--title text-white">White Minimalist <br>
                                    Combo Sofa </h2>
                                <span class="banner__content--style2__link primary__btn style2 text-white">Buy Now</span>  
                            </div>
                        </a>
                    </div>
                    <div class="banner__items position__relative">
                        <a class="banner__items--thumbnail " href="/shopLeft_Sidebar"><img class="banner__items--thumbnail__img banner__img--height" src="assets/img/banner/banner14.webp" alt="banner-img">
                            <div class="banner__content--style2">
                                <h3 class="banner__content--style2__subtitle text-ofwhite d-md-none">Get Discount Up to 80%</h3>
                                <h2 class="banner__content--style2--title text-white">White Minimalist <br>
                                    Combo Sofa </h2>
   ...
   <!-- Start banner section -->
                ...
                <div class="col">
                    <div class="banner__section--inner d-flex align-items-center">
                        <div class="banner__discount--content">
                            ...
                            <a class=" primary__btn btn__style2" href="/shopLeft_Sidebar" rel="nofollow">Discover More</a>    
                        </div>
                        <div class="banner2__right--sidebar position__relative d-flex">
                            <div class="banner2__sidebar--items one position__relative">
                                <a class="banner__items--thumbnail " href="/shopLeft_Sidebar" rel="nofollow"><img class="banner__items--thumbnail__img" src="assets/img/banner/banner17.webp" alt="banner-img"></a>
                            ...
                            <div class="banner2__sidebar--items two position__relative">
                                <a class="banner__items--thumbnail " href="/shopLeft_Sidebar" rel="nofollow"><img class="banner__items--thumbnail__img" src="assets/img/banner/banner16.webp" alt="banner-img"></a>
                            </div>
                            <div class="banner2__sidebar--items three position__relative">
                                <a class="banner__items--thumbnail " href="/shopLeft_Sidebar" rel="nofollow"><img class="banner__items--thumbnail__img" src="assets/img/banner/banner15.webp" alt="banner-img"></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="product__section--header d-flex justify-content-between mb-40">
                ...
                <ul class="product__tab--btn style2 d-flex justify-content-center">
                    <li class="product__tab--btn__list style2 active" data-toggle="tab" data-target="#chair">Chair </li>
                    <li class="product__tab--btn__list style2" data-toggle="tab" data-target="#sofa">Sofa </li>
                    <li class="product__tab--btn__list style2" data-toggle="tab" data-target="#lamp">Lamp </li>
                    <li class="product__tab--btn__list style2" data-toggle="tab" data-target="#table">Table </li>
                    <li class="product__tab--btn__list style2" data-toggle="tab" data-target="#monitor">Monitor </li>
                </ul>
            </div>
                        ...
                        <div class="row row-cols-lg-4 row-cols-md-3 row-cols-2 mb--n30">
                                ...
                                <div class="product__items ">
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link" href="/standardProduct">
                                            <img class="product__items--img product__primary--img" src="assets/img/product/product2.webp" alt="product-img">
                                        ...
                                        <ul class="product__items--action style2">
                                            ...
                                            <li class="product__items--action__list style2">
                                                <a class="product__items--action__btn style2" href="/wishlistPage">
                                            ...
                                            <li class="product__items--action__list style2">
                                                <a class="product__items--action__btn style2" href="/comparePage">
                                    ...
                                    <div class="product__items--content text-center">
                                        ...
                                        <a class="product__items--content__tag" href="/standardProduct">Chair</a>
                                        ...
                                        <a class="product__items--action__cart--btn primary__btn btn__style2" href="/cartPage">
                            ...
                            <div class="col mb-30">
                                <div class="product__items ">
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link" href="/standardProduct">
                                            <img class="product__items--img product__primary--img" src="assets/img/product/product8.webp" alt="product-img">
                                            <img class="product__items--img product__secondary--img" src="assets/img/product/product7.webp" alt="product-img">
                                        </a>
                                        <ul class="product__items--action style2">
                                            <li class="product__items--action__list style2">
                                                <a class="product__items--action__btn style2" data-open="modal1" href="javascript:void(0)">
                            ...
                            <div class="col mb-30">
                                <div class="product__items ">
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link" href="/standardProduct">
                                            <img class="product__items--img product__primary--img" src="assets/img/product/product10.webp" alt="product-img">
                                            <img class="product__items--img product__secondary--img" src="assets/img/product/product9.webp" alt="product-img">
                                        </a>
                                        <div class="product__badge style2">
                            ...
                            <div class="col mb-30">
                                <div class="product__items ">
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link" href="/standardProduct">
                                            <img class="product__items--img product__primary--img" src="assets/img/product/product12.webp" alt="product-img">
                                            <img class="product__items--img product__secondary--img" src="assets/img/product/product11.webp" alt="product-img">
                                        </a>
                                        <ul class="product__items--action style2">
                                            <li class="product__items--action__list style2">
                                                <a class="product__items--action__btn style2" data-open="modal1" href="javascript:void(0)">
                            ...
                            <div class="col mb-30">
                                <div class="product__items ">
                                    ...
                                    <div class="product__items--content text-center">
                                        ...
                                        <a class="product__items--content__tag" href="/standardProduct">Chair</a>
                                        <h3 class="product__items--content__title h4"><a href="/standardProduct">Globe Electric Lamp</a></h3>
                                        <div class="product__items--price">
                                ...
                                <div class="product__items ">
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link" href="/standardProduct">
                                            ...
                                            <img class="product__items--img product__secondary--img" src="assets/img/product/product15.webp" alt="product-img">
                                        </a>
                                        <ul class="product__items--action style2">
                                            <li class="product__items--action__list style2">
                                                <a class="product__items--action__btn style2" data-open="modal1" href="javascript:void(0)">
    ...
    <div class="deals__banner--section color-scheme-2 section--padding pt-0">
        <div class="container">
            <div class="deals__banner--thumbnail mt-0">
                <a class="deals__banner--thumbnail__link display-block position__relative" href="/shopLeft_Sidebar"><img class="deals__banner--thumbnail__img style2 display-block" src="assets/img/banner/banner-bg3.webp" alt="deals-thumbnail-img">
                ...
                <div class="row">
                    <div class="col-lg-5 col-md-8 col-md-order offset-md-2 offset-lg-0">
                        <div class="product__banner">
                            <a class="product__banner--thumbnail display-block position__relative" href="/shopLeft_Sidebar"><img class="product__banner--thumbnail__img display-block" src="assets/img/banner/banner18.webp" alt="banner-img">
                                <div class="product__banner--content">
                                    <h4 class="product__banner--content__subtitle text-white">Limited Price Offer! </h4>
                ...
                <div class="categories__content">
                    ...
                    <ul class="categories__product d-flex">
                        <li class="categories__product--list">
                            <a class="categories__product--icons" href="/shopLeft_Sidebar"><svg class="categories__product--icons__svg" xmlns="http://www.w3.org/2000/svg" width="28.626" height="26.234" viewBox="0 0 28.626 26.234">
                        ...
                        <li class="categories__product--list">
                            <a class="categories__product--icons" href="/shopLeft_Sidebar">
                    ...
                    <a class="categories__content--btn primary__btn btn__style2" href="/shopLeft_Sidebar">See All Categories</a>     
                </div>
                <div class="categories__sidebar">
                    <div class="categories__sidebar--inner">
                        <div class="banner__items position__relative">
                            <a class="banner__items--thumbnail " href="/shopLeft_Sidebar"><img class="banner__items--thumbnail__img" src="assets/img/banner/banner19.webp" alt="banner-img"></a>
    ...
    <section class="newsletter__banner--section section--padding color-scheme-2">
        <div class="container">
            <div class="newsletter__banner--thumbnail position__relative">
                <img class="newsletter__banner--thumbnail__img" src="assets/img/banner/banner-bg4.webp" alt="newsletter-banner">
                <div class="newsletter__content style2 newsletter__subscribe">
                    ...
                    <form class="newsletter__subscribe--form position__relative" action="#">
                        ...
                        <button class="newsletter__subscribe--button primary__btn btn__style2" type="submit">Subscribe
            ...
            <div class="blog__section--inner blog__swiper--column3 swiper">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="blog__items">
                            <div class="blog__thumbnail">
                                <a class="blog__thumbnail--link display-block" href="/blogDetails"><img class="blog__thumbnail--img display-block" src="assets/img/blog/blog1.webp" alt="blog-img"></a>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="blog__items">
                            <div class="blog__thumbnail">
                                <a class="blog__thumbnail--link display-block" href="/blogDetails"><img class="blog__thumbnail--img display-block" src="assets/img/blog/blog2.webp" alt="blog-img"></a>
                            </div>
                            <div class="blog__content">
                                <ul class="blog__content--meta d-flex">
                                    <li class="blog__content--meta__text">
                                ...
                                <h3 class="blog__content--title h4"><a href="/blogDetails">Lorem, ipsum dolor sit amet are consectetur adipisicing elit.</a></h3>
                                <p class="blog__content--desc">Mum ut perspiciatis unde omnis iste
                                    natus error sit voluptatem…..</p>
                                <a class="blog__content--btn primary__btn" href="/blogDetails">Read more </a>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="blog__items">
                            <div class="blog__thumbnail">
                                <a class="blog__thumbnail--link display-block" href="/blogDetails"><img class="blog__thumbnail--img display-block" src="assets/img/blog/blog3.webp" alt="blog-img"></a>
                            </div>
                            <div class="blog__content">
                                <ul class="blog__content--meta d-flex">
                                    <li class="blog__content--meta__text">
                                ...
                                <h3 class="blog__content--title h4"><a href="/blogDetails">Amet consectetur adipisicing elit. Commodi placeat iure there are.</a></h3>
                                <p class="blog__content--desc">Mum ut perspiciatis unde omnis iste
                                    natus error sit voluptatem…..</p>
                                <a class="blog__content--btn primary__btn" href="/blogDetails">Read more </a>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="blog__items">
                            <div class="blog__thumbnail">
                                <a class="blog__thumbnail--link display-block" href="/blogDetails"><img class="blog__thumbnail--img display-block" src="assets/img/blog/blog4.webp" alt="blog-img"></a>
                            </div>
                            <div class="blog__content">
                                <ul class="blog__content--meta d-flex">
                                    <li class="blog__content--meta__text">
