                                ...
                                <div class="swiper-slide ">
                                    <div class="hero__slider3--items hero__slider--bg3 slider1">
                                        <div class="slider__content3 padding-left">
                                            ...
                                            <a class="slider__content3--btn primary__btn btn__style3" href="/shopLeft_Sidebar" rel="nofollow">Order Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide ">
                    ...
                    <div class="row row-cols-lg-6 row-cols-md-4 row-cols-sm-3 row-cols-2  mb--n30">
                        <div class="col mb-30">
                            <div class="categories__product--items border border-radius-5 text-center">
                                <a class="categories__product--items__link" href="/shopLeft_Sidebar">
                        ...
                        <div class="swiper-slide">
                            <div class="product__items ">
                                ...
                                <div class="product__items--content text-center">
                                    ...
                                    <a class="product__items--action__cart--btn primary__btn btn__style3" href="/cartPage">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-7 col-md-7">
                        <div class="choiceus__banner position__relative d-flex">
                            <a class="choiceus__banner--thumbnail one display-block" href="/shopLeft_Sidebar" rel="nofollow"><img class="choiceus__banner--thumbnail__img display-block" src="assets/img/banner/banner23.webp" alt="banner-img"></a>
                            <a class="choiceus__banner--thumbnail two display-block" href="/shopLeft_Sidebar" rel="nofollow"><img class="choiceus__banner--thumbnail__img two display-block" src="assets/img/banner/banner24.webp" alt="banner-img"></a>
                    ...
                    <div class="col-lg-5 col-md-5">
                        <div class="choiceus__content">
                            ...
                            <a class="choiceus__info--btn primary__btn btn__style3" href="/aboutUs">Read More</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row row-cols-lg-3 row-cols-md-2 row-cols-sm-2 row-cols-1 mb--n28">
                    <div class="col mb-28">
                        <div class="banner__items">
                            <a class="banner__items--thumbnail position__relative" href="/shopLeft_Sidebar"><img class="banner__items--thumbnail__img" src="assets/img/banner/banner20.webp" alt="banner-img">
        ...
        <div class="deals__banner--section color-scheme-3 section--padding pt-0">
            <div class="container">
                <div class="deals__banner--thumbnail mt-0">
                    <a class="deals__banner--thumbnail__link display-block position__relative" href="/shopLeft_Sidebar"><img class="deals__banner--thumbnail__img style2 display-block" src="assets/img/banner/banner-bg5.webp" alt="deals-thumbnail-img ">
            ...
            <div class="container">
                <div class="new__product--section__inner d-flex align-items-center">
                    <div class="new__product--content">
                        ...
                        <a class="new__product--content__btn primary__btn btn__style3" href="/shopLeft_Sidebar">View More</a>  
                    </div>
                        ...
                        <div class="swiper-slide">
                            <div class="blog__items">
                                ...
                                <div class="blog__content text-center">
                                    ...
                                    <a class="blog__content--btn primary__btn btn__style3" href="/blogDetails">Read more </a>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
