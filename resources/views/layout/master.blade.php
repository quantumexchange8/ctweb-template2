...
<head>
    <meta charset="utf-8">
    <title>Current Tech Template 2</title>
    <meta name="description" content="Morden Bootstrap HTML5 Template">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="shortcut icon" type="Current Tech Template 2" href="favicon.ico">
                            ...
                            <form action="#">
                                ...
                                <div class="product__variant">
                                    ...
                                    <div class="quickview__variant--list variant__wishlist mb-15">
                                        <a class="variant__wishlist--icon" href="/wishlistPage" title="Add to wishlist">
